...
<section id="edit-sistemaDeMolinetes" class="first">
	...
	<g:form method="post" class="form-horizontal" >
		<g:hiddenField name="id" value="${sistemaDeMolinetesInstance?.id}" />
		<g:hiddenField name="version" value="${sistemaDeMolinetesInstance?.version}" />
		<fieldset class="form">
