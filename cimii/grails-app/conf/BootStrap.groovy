...
class BootStrap {
    ...
    def init = { servletContext ->
		...
		def linea = new Linea(nombre: "Linea H",frecuencia:new Frecuencia(frecuenciaStandard:300,cantidadPersonasEnRed:5000,frecuenciaActual:300), sistemaDeMolinetes: new SistemaDeMolinetes(flujo:50))
